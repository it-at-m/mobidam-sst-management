...
@PreAuthorize("hasAuthority(T(de.muenchen.mobidam.security.AuthoritiesEnum).MOBIDAM_SST_MANAGEMENT_BACKEND_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.mobidam.security.AuthoritiesEnum).MOBIDAM_SST_MANAGEMENT_BACKEND_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.mobidam.security.AuthoritiesEnum).MOBIDAM_SST_MANAGEMENT_BACKEND_DELETE_THEENTITY.name())")
